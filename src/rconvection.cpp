...
void RConvection::setMaterial(const RMaterial &material, double temperature)
{
    ...
    unsigned int roPos = material.findPosition(RMaterialProperty::Density);
    unsigned int muPos = material.findPosition(RMaterialProperty::DynamicViscosity);
    unsigned int cPos = material.findPosition(RMaterialProperty::HeatCapacity);
    unsigned int kPos = material.findPosition(RMaterialProperty::ThermalConductivity);
    unsigned int bPos = material.findPosition(RMaterialProperty::ThermalExpansionCoefficient);
