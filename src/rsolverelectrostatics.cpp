...
void RSolverElectrostatics::prepare(void)
{
    ...
    this->generateMaterialVecor(RMaterialProperty::RelativePermittivity,this->elementRelativePermittivity);
    this->generateMaterialVecor(RMaterialProperty::ElectricalConductivity,this->elementElectricConductivity);
